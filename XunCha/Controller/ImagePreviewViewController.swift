...
class ImagePreviewViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "取消", style: .done, target: self, action: #selector(backToTheMark))
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .trash, target: self, action: #selector(trashThePhoto))
    ...
    @objc func backToTheMark() {
        self.dismiss(animated: true, completion: nil)
    }
    @objc func trashThePhoto() {
