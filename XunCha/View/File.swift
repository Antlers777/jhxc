...
//    public let myareaSketchEditor = AGSSketchEditor()
//    
...
//    }
//    
//    private func startFreehandPolygon() {
...
//        selectionOverlay?.isVisible = false
//        self.items = sketchModeButtons
//        mapView?.sketchEditor = myareaSketchEditor
//        
//        if !myareaSketchEditor.isStarted {
//            myareaSketchEditor.start(with: AGSSketchCreationMode.freehandPolygon)
//        }
//    }
//    
...
//        }  else if mapView?.sketchEditor == myareaSketchEditor ||
//                    selectedGeometry?.geometryType == .envelope ||
//                    selectedGeometry?.geometryType == .polygon {
//            let areaUnitIDs: [AGSAreaUnitID] = [.hectares, .squareKilometers, .squareMeters, .squareMiles]
//            units = areaUnitIDs.compactMap { AGSAreaUnit(unitID: $0) }
...
//            sketchEditor == lineSketchEditor || sketchEditor == areaSketchEditor || sketchEditor == myareaSketchEditor else {
//                return
//        }
//        updateMeasurement()
//    }
...
//            }
//        case .freehandPolygon:
//            let measurement = Measurement(value: mycalculateSketchArea(), unit: selectedAreaUnit)
//            resultView.measurement = measurement
//        }
//        
//    }
...
//    
//    // my
//    private func mycalculateSketchArea() -> Double {
//        guard mapView?.sketchEditor?.isSketchValid == true, let geom = mapView?.sketchEditor?.geometry else {
//            return 0
//        }
//        
//        return mycalculateArea(of: geom)
//    }
//    
//    private func mycalculateArea(of geom: AGSGeometry) -> Double {
//        // if planar is very large then just return that, geodetic might take too long
//        if let linearUnit = geom.spatialReference?.unit as? AGSLinearUnit {
//            let planar = AGSGeometryEngine.area(of: geom)
//            if let planarMiles = linearUnit.toAreaUnit()?.convert(planar, to: AGSAreaUnit.squareMiles()),
