...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/ArcGIS-Runtime-SDK-iOS/ArcGIS.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ArcGIS-Runtime-Toolkit-iOS/ArcGISToolkit.framework"
